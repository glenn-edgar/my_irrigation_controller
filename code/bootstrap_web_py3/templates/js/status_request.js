...
function status_update( data )
{
       ...
       $("#plc_flow_rate").html("PLC Flow Rate: "+parseFloat(data.PLC_FLOW_METER).toFixed(2));
        $("#filtered_flow").html("Filtered Hunter Flow Rate: "+parseFloat(data.FILTERED_HUNTER_VALVE).toFixed(2));
       $("#hunter_flow").html("Hunter Flow Rate: "+parseFloat(data.HUNTER_VALVE).toFixed(2));
       ...
       $("#hunter_hires").html("Hunter HIRES Flow Rate:   "+parseFloat(data.HUNTER_HIRES_VALVE).toFixed(2))
