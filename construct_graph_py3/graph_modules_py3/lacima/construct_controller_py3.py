...
class Construct_Lacima_Controllers(object):
   ...
   def __init__(self,bc,cd):
       ...
       #properties["command_list"].append( { "file":"mqtt_scan_data_py3.py","restart":False })
       #properties["command_list"].append( { "file":"mqtt_redis_gateway_py3.py","restart":False })
       
       #properties["command_list"].append( { "file":" -m  mqtt_clients.mqtt_local_publish_server_py3","restart":False })
