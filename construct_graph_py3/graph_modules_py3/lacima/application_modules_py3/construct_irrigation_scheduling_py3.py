...
class Construct_Irrigation_Scheduling_Control(object):
   ...
   def __init__(self,bc,cd):
      ...
      cd.add_redis_stream("IRRIGATION_PAST_ACTIONS",3000,forward=True)
      ...
      bc.add_info_node("MASTER_VALVES","MASTER_VALVES",properties={"MASTER_VALVES":[ {"remote":"satellite_1","pins":[43] }, {"remote":"satellite_1","pins":[38] }  ]} )
      ...
      fields["HUNTER_VALVE"]    =    { "type":"float","init_value":0 }
      fields["FILTERED_HUNTER_VALVE"]    =    { "type":"float","init_value":0 }
      fields["HUNTER_HIRES_VALVE"]    =    { "type":"float","init_value":0 }
